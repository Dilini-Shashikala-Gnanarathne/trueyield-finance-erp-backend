package com.financeapp.payslip.config;
...
/**
 * Kafka Consumer Configuration for payslip-service.
 *
 * <p>Uses consumer group 'payslip-service', distinct from 'notification-service'.
 * Demonstrates Kafka fan-out with independent offsets and AckMode.MANUAL.</p>
 */
@EnableKafka
@Configuration
